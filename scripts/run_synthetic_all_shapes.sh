...
#         # SYN_PATCH_PATH="runs/paper_results/synthetic_patches_${LMBD}_patch_dim_${PATCH_DIM}/synthetic-10x20_bottom/rect-458.0-610.0"
...
#         # mv runs/val/synthetic-10x20_bottom/rect-458.0-610.0 $SYN_PATCH_PATH
#         # rm -r runs/val
#     done
# done
...
do
    ...
    do 
        ...
        do
            ...
            OLD_EXP_PATH="runs/paper_results/synthetic_tl_rt_attack_lambda_${LMBD}_patch_dim_${PATCH_DIM}/synthetic-10x20_bottom_mapillary_load_${index}"
            UPDATED_OLD_EXP_PATH="runs/paper_results/synthetic_tl_rt_attack_lambda_${LMBD}_patch_dim_${PATCH_DIM}/synthetic-10x20_bottom_mapillary_load_${index}_before_update"
            echo $OLD_EXP_PATH
            echo $UPDATED_OLD_EXP_PATH
            mv $OLD_EXP_PATH $UPDATED_OLD_EXP_PATH
            
            mv runs/val/synthetic-10x20_bottom_mapillary_load_${COUNTER} $OLD_EXP_PATH
            COUNTER=$((COUNTER + 1))
        done
