...
shapes_arr=([3]="diamond-600.0" [4]="diamond-915.0" [5]="square-600.0")
...
do
    ...
    do
        ...
        do
            REAL_PATCH_PATH="runs/paper_results_new/real_patches_relighting_1_${LMBD}_patch_dim_${PATCH_DIM}_mask_name_${MASK_NAME}"
            CUR_EXP_PATH="runs/paper_results_new/real_attack_real_gen_lambda_${LMBD}_patch_dim_${PATCH_DIM}_mask_name_${MASK_NAME}_1"
