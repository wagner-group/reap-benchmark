...
# for 10x10
# do
#     gen real patch translate+scale+relight and test on translate+scale+relight
...
do
    ...
    do  
        ...
        do
            ...
            ATTACK_CONFIG_PATH="./configs/attack_config_real_translate_scale_relighting_1_lmbd_${LMBD}_patch_dim_${PATCH_DIM}.yaml"
            REAL_PATCH_PATH="runs/paper_results_new/real_patches_translate_scale_relighting_1_${LMBD}_patch_dim_${PATCH_DIM}_mask_name_${MASK_NAME}"
...
do
    ...
    do
        ...
        do
            REAL_PATCH_PATH="runs/paper_results_new/real_patches_translate_scale_relighting_1_${LMBD}_patch_dim_${PATCH_DIM}_mask_name_${MASK_NAME}"
            CUR_EXP_PATH="runs/paper_results_new/real_attack_real_gen_translate_scale_relighting_1_lambda_${LMBD}_patch_dim_${PATCH_DIM}_mask_name_${MASK_NAME}"
