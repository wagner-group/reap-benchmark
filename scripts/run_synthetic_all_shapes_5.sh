...
# for 10x10
# do
#     gen real patch 3D + no relight and test on 3D + no relight
...
do
    ...
    do  
        ...
        do
            ...
            ATTACK_CONFIG_PATH="./configs/attack_config_real_relighting_0_lmbd_${LMBD}_patch_dim_${PATCH_DIM}.yaml"
            REAL_PATCH_PATH="runs/paper_results_new/real_patches_relighting_0_${LMBD}_patch_dim_${PATCH_DIM}_mask_name_${MASK_NAME}"
...
do
    ...
    do
        ...
        do
            EXP_NAME="real-${MASK_NAME}_bottom"
            REAL_PATCH_PATH="runs/paper_results_new/real_patches_relighting_0_${LMBD}_patch_dim_${PATCH_DIM}_mask_name_${MASK_NAME}"
            CUR_EXP_PATH="runs/paper_results_new/real_attack_real_gen_relighting_0_lambda_${LMBD}_patch_dim_${PATCH_DIM}_mask_name_${MASK_NAME}"
