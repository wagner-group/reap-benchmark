...
# shapes_arr=( "diamond-600.0" "diamond-915.0" "square-600.0" "rect-458.0-610.0" "rect-762.0-915.0" "rect-915.0-1220.0" "pentagon-915.0" "octagon-915.0")
# shapes_arr=("circle-750.0" "triangle-900.0" "triangle_inverted-1220.0")
shapes_arr=([6]="rect-458.0-610.0" [7]="rect-762.0-915.0" [8]="rect-915.0-1220.0")
...
do
    ...
    do
        ...
        do
            REAL_PATCH_PATH="runs/paper_results_new/real_patches_relighting_1_${LMBD}_patch_dim_${PATCH_DIM}_mask_name_${MASK_NAME}"
            CUR_EXP_PATH="runs/paper_results_new/real_attack_real_gen_lambda_${LMBD}_patch_dim_${PATCH_DIM}_mask_name_${MASK_NAME}_2"
